...
func TestCondenseSession_CopilotScopedCheckpointMetadataAndSessionBackfill(t *testing.T) {
	...
	transcript := strings.Join([]string{
		...
		`{"type":"session.shutdown","data":{"modelMetrics":[{"modelId":"claude-sonnet-4.6","requests":{"count":2},"usage":{"inputTokens":0,"outputTokens":35,"cacheReadTokens":20,"cacheWriteTokens":10}}]},"id":"9","timestamp":"2026-03-17T00:00:08Z","parentId":""}`,
	}, "\n") + "\n"
